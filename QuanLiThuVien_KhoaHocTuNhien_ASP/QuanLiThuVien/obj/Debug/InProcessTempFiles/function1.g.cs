...
namespace QuanLiThuVien.Content.JS {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class function1 : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(function1).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(function1));
        ...
        private string FindResource() {
            string[] resources = typeof(function1).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".function1.g.xaml") || resource.Equals("function1.g.xaml"))) {
                    return resource;
                }
            }
